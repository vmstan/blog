...
- The new remote is very handy, and a nice upgrade from the previous one. The touch-sensitive panel is very sensitive and takes some getting used to. I’ve used the motion controller on a couple of games, and it’s fun but not something I’d probably do a lot of.
- The volume control and TV power are controlled through the new remote, and I didn’t have to do anything to program it.
